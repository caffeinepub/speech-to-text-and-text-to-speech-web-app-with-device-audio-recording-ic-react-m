...
export class Backend implements backendInterface {
    ...
    async getAllTranscriptionHistories(): Promise<Array<[Principal, Array<TranscriptEntry>]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTranscriptionHistories();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTranscriptionHistory(): Promise<Array<TranscriptEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTranscriptionHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveTranscriptionEntry(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveTranscriptionEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
